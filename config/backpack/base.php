...
return [
    ...
    */
    ...
    'project_name' => 'Телефонный справочник',
    ...
    // 'project_logo'   => '<img width="50px" src="' . config("app.url") . '/images/fts_eagle_256w.png" />',
    'project_logo'   => '',
    ...
    'developer_name' => 'Maxim Ishchenko <maxim.ishchenko@gmail.com>',
    ...
    */
    ...
    // If you need to switch to username, you also need to create that column in your
    // 'authentication_column'      => 'name',
    // 'authentication_column_name' => 'Name',
    'authentication_column'      => 'email',
    'authentication_column_name' => 'Имя пользователя',
