...
$(function () {
  $.extend({
    btnUp: function btnUp(e) {
      ...
      var t = $("#" + e.elementID);
      t.hide();
      var n = null != window.pageXOffset ? function () {
        return {
          left: pageXOffset,
          top: pageYOffset
        };
        ...
        var e = document.documentElement,
            t = document.body,
            n = e.scrollTop || t && t.scrollTop || 0;
        n -= e.clientTop;
        var o = e.scrollLeft || t && t.scrollLeft || 0;
        return {
          top: n,
          left: o -= e.clientLeft
        };
      ...
      $(window).on("scroll", function () {
        n().top > e.showButtonHeight ? t.fadeIn(300) : t.fadeOut(300);
      }).trigger("scroll"), t.children().on("click", function () {
